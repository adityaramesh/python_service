...
set shortmess=aoO
badd +344 system_v.py
badd +24 README.md
badd +0 test/dummy_service.py
args ~/projects/utility/python_service/system_v.py
edit system_v.py
...
silent! normal! zE
let s:l = 269 - ((53 * winheight(0) + 32) / 64)
